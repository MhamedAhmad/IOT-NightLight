...
#define NUMPIXELS 3 // using over 8 pixels with ESP32 requires external power supply 
...
void loop() {
  ...
  for(int hue=0; hue<65536; hue+=10) { // For each pixel...
    ...
    pixels.fill(rgbcolor,0,2); // this will fill neopixels 0-2 
    pixels.fill(rgbcolor_corrected,2,3); // this will fill neopixels 3-5
