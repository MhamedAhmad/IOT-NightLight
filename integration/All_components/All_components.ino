...
void light(float fraction, bool motion=false)
{
  ...
  if(motion)
    ...
    brightness = fraction * high_brightness + (1-fraction) * low_brightness;
...
{
  high_brightness = (getValue(String(brightness.c_str()), '+', 0)).toInt();
  low_brightness = (getValue(String(brightness.c_str()), '+', 1)).toInt();
  motion_brightness = (getValue(String(brightness.c_str()), '+', 2)).toInt();
  prefs.putInt("high_brightness", high_brightness);
  prefs.putInt("low_brightness", low_brightness);
  prefs.putInt("motion_brightness", motion_brightness);
  detectMotion();
}
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
...
void loadPixelSettings()
{
  ...
  motion_brightness = prefs.getInt("motion_brightness", 0);
}
//load times settings
